<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="AddUser.aspx.vb" Inherits="AddUser" %>
...
&nbsp;<strong><span style="color: #FFFFFF">USER NAME<br />
                    ...
                    <br />
                    USER TYPE<br />
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="70%" AutoPostBack="True" ViewStateMode="Enabled">
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Button1" runat="server" BackColor="White" Font-Bold="True" Text="SUBMIT" Width="70%" />
                    <br />
                    <br />
