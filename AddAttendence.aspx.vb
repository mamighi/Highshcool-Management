...
Partial Class AddAttendence
    ...
    Public Sub loadlist()
        ...
        For Each student As String In students
            ...
            ddl.Items.Add("PRESENT")
            ddl.Items.Add("ABSENT")
            ddl.Items.Add("ABSENT WITH REASON")
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ts.addAttendec(studentlist, attendencest, modul, today)
        Session("MSG") = "Attendence Added Successfully."
