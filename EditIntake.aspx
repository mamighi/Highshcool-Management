<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="EditIntake.aspx.vb" Inherits="EditIntake" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div style="margin-left:25%; width:50%; background-color: #0099FF;" class="text-center">
            ...
            <br />
            INTAKE CODE<br />
            <asp:DropDownList ID="DropDownList1" runat="server" Width="60%" AutoPostBack="True">
            </asp:DropDownList>
            </span>
            <br />
            <br />
